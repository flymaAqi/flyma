            ...
            logData: [
                {
                    ...
                    version: 'v3.0.2',
                    data: '2025/03/18',
                    info: ['1.新增tabbar组件', '2.新增音乐播放器组件已引入模板使用', '3.针对所有待加载资源优化', '4.将云端tabbar图片放进本地供开发者调试']
                },
                {
					imgUrls:[
					...
					tip:'亲测此次优化后首屏加载时间控制在600ms到500ms之间(开启网络缓存或数据加载完后再去请求静态图片)',
                ...
                },
                {
                    ...
                    info: ['1.大部分组件内部结构更新,增加耦合', '2.大部分组件基础样式大更新', '3.拆解组件,降低耦合','4.底层css样式大更新','5.首屏数据渲染优化','6.增加新轮播组件以及刷新组件','7.增加新导航栏组件','8.重构tabbar','9.为部分延时器增加防抖函数','10.代码开源'],
